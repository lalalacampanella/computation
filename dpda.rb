...
#stack = Stack.new(['a','b','c','d'])
#puts(stack)
#puts(stack.top)
#puts(stack.pop)
#puts(stack.push('a'))

#puts (rule = PDARule.new(1,'(', 2, '$', ['b', '$']))
#puts (configuration = PDAConfiguration.new(1, Stack.new(['$'])))
...
#puts (configuration = rulebook.next_configuration(configuration, ')'))
#puts (configuration = rulebook.follow_free_moves(configuration))
#puts (rulebook.next_configuration(configuration, '('))
...
puts(dpda_design.accepting?("(())"))
puts(dpda_design.accepting?("(()"))
puts(dpda_design.accepting?("(())wawa"))
